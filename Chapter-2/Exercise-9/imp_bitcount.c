...
/* In binary subtraction, when you 0 - 1, you borrow from the next higher significant
 * bit. Which is translated in change the next 1 you encounter to 0 while changing all
 * 0 to 1's you encounter. This has the effect of masking the remainder of the number
 * up until that bit.
 *
 *            1111 1000 
 * 	    - 0000 0001
